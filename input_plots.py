...
print(ratio_df.head())
print(ratio_df.groupby(['provider','input_size'])['p99'].describe()['mean'])
print(ratio_df.groupby(['provider','input_size'])['median'].describe()['mean'])
print(ratio_df.groupby(['provider','input_size'])['p99_to_median'].describe()['mean'])
...
print(ratio_df[['provider','input_size','p99_to_median']].head())
